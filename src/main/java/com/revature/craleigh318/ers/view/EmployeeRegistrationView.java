...
public class EmployeeRegistrationView {
	...
	private static final String BASE_HTML = "<h1>Register New Employee</h1><form method=\"post\"><table><tr><td>Username:</td><td><input name=\""+AttributeNames.RGSTR_USERNAME+"\" type=\"text\" /></td></tr><tr><td>Temporary Password:</td><td><input name=\""+AttributeNames.RGSTR_PASSWORD+"\" type=\"password\" /></td></tr></table><input type=\"submit\" value=\"Register\" /></form>%s";
